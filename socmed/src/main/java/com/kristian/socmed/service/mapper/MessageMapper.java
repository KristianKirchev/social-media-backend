...
public class MessageMapper implements GenericMapper<MessageDto, Message>{
    ...
    public Message toEntity(MessageDto dto) {
        ...
        message.setFromUser(userRepository.findByUsername(dto.getFromUser()).orElseThrow(()->new MyRuntimeException("User not found")));
        message.setToUser(userRepository.findByUsername(dto.getToUser()).orElseThrow(()->new MyRuntimeException("User not found")));
